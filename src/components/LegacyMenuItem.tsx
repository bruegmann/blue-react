 ...
 */
export default function LegacyMenuItem(props: LegacyMenuItemProps) {
    const id = `blue-menu-item-wrapper-${Math.random()
        .toString(36)
        .substring(7)}`
    ...
    const onClickOutside = ({ target }: MouseEvent) => {
        ...
        if (ignoreClasses && target) {
            for (let i = 0; i < ignoreClasses.length; i++) {
                if (
                    (target as HTMLElement | null)?.classList.contains(
                        ignoreClasses[i]
                    ) ||
            ...
            {createElement(
                ...
                <>
                    ...
                    {props.label && (
                        <span
                            className={clsx(
                                "blue-menu-item-label text-truncate",
                    ...
                    {props.children && (
                        <Chevron
                            ...
                            mirrored
                            className={clsx(
                                "blue-menu-item-dropdown-caret ms-auto",
