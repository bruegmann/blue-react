...
function CollapseGroup({ className, children, ...props }: NewMenuItemProps) {
    return (
...
function PopoverGroup({ children, iconAfter, ...props }: NewMenuItemProps) {
    const id = useId()
    return (
        <>
            <Base
...
export default function NewMenuItem({ as, ...props }: NewMenuItemProps) {
    const Comp =
        as === "collapse"
            ? Collapse
            : as === "collapse-group"
