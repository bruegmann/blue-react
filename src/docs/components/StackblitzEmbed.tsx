        ...
        <>
            {loadIframe ?
                <div className="ratio ratio-16x9 bg-light rounded">
                    <iframe className="rounded" src="https://stackblitz.com/edit/blue-react-app-stackblitz-rr6xeh?embed=1&file=index.tsx&hideExplorer=1" />
                </div>
                :
                <div className="bg-primary text-white rounded p-4 d-flex justify-content-between" style={{ backgroundImage: `url(${image})` }}>
                    <div>
                        ...
                        <a className="btn btn-link text-white" href="https://stackblitz.com/edit/blue-react-app-stackblitz-rr6xeh?" target="_blank" rel="noopener noreferrer">Open content in new tab</a>
