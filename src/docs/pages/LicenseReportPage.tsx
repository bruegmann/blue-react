...
export default function LicenseReportPage() {
    return (
        <>
            <div className="d-flex flex-column docs-min-height-100vh">
                <div className="container-fluid pt-5 pt-md-0 flex-grow-1">
                    <article className="docs-blog-content">
                        ...
                        <p>
                            Listed below are all third-party dependencies and
                            development dependencies with their license notices:
                        </p>
