import{j as e,h as o,i as s,H as r}from"./index-CFBwN0Ss.js";class u extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.addEventListeners()}render(){if(!this.shadowRoot)return;const a=(document.documentElement.lang||navigator.language).startsWith("de")?"Seitenleiste umschalten":"Toggle sidebar";this.shadowRoot.innerHTML=`
            <style>
                :host {
                    --spacing: 0.25rem;
